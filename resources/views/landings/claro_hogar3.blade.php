   ...
   <!-- <div id="simple" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;">-->
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <h3  class="text-primary "><strong> Conoce nuestros Planes Claro Hogar </strong> </h3>
             ...
             <center> <strong><h4> Promocion Validad Hasta el 31 de Diciembre</h4> </strong></center>
            <div id="opt1" class="p-2 pl-3">
                               ...
                               <a onclick="Mens1();" class="btn bg-white text-danger col-12 mt-2"> <img class="col-12 mt-2" style="max-width:400px;" src="https://i.ibb.co/99R21bv/1-22.jpg"></a> <br>
                                ...
                                <a onclick="Mens2();" class="btn bg-white text-danger col-12 mt-2"> <img class="col-12 mt-2" style="max-width:400px;" src="https://i.ibb.co/FstbZ6X/2-22.jpg"></a> <br>
                                <a onclick="Mens3();" class="btn bg-white text-danger col-12 mt-2"> <img class="col-12 mt-2" style="max-width:400px;" src="https://i.ibb.co/qxrvrd6/3-22.jpg"></a> </center>
...
<center>
            <h3  class="text-primary "><strong>  Plan: Internet  </strong> </h3>
    ...
    <div id="opt11" class="p-2 pl-3">
                        <div class="card">     
                            <div class="card-body">
                             ...
                             <button onclick="Mens2();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://i.ibb.co/FstbZ6X/2-22.jpg"> <strong></strong> </button>
                             <button onclick="Mens3();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://i.ibb.co/qxrvrd6/3-22.jpg"> <strong> </strong> </button>
                            </div>
                        </div>
            </div>
</div>
...
<div class="card">     
    ...
    <div id="opt12" class="p-2 pl-3">
                        <div class="card">     
                            <div class="card-body">
                               <button onclick="Mens1();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://i.ibb.co/99R21bv/1-22.jpg"> <strong> </strong> </button>
    ...
    <center>
            ...
            <h4> Disfruta de Internet en alta velocidad, entretenimiento en HD </h4> </center>
    <div class="card">     
         <div class="card-body">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
     <ol class="carousel-indicators">
     ...
     <div class="carousel-inner">
        <div class="item active">
        <center> <a onclick="sendMail('Solicito ser Contactado 2 Play: Internet + Tv'); ;eventosLanding('Informacion 2 Play: Internet + Tv'); return false;">
          <img class="col-12 mt-2" style="max-width:350px; max-height:350px " src="https://i.ibb.co/Scvm5gb/image008.png" alt=""> </a> <br> 
          </center> <br> <br>
          <button onclick="sendMail('Solicito ser Contactado 2 Play: Internet + Tv'); ;eventosLanding('Informacion 2 Play: Internet + Tv'); return false;" class="btn bg-danger text-white col-12 mt-2"><h4>Contáctenme</h4></button>
          <br> <br> <br> 
        </div>
        <div class="item">
        <center><a onclick="sendMail('Solicito ser Contactado Plan 2 Play: Internet + Tv'); ;eventosLanding('Solicitud Informacion  2 Play: Internet + Tv'); return false;"> 
        <img class="col-12 mt-2" style="max-width:350px; max-height:350px "  src="https://i.ibb.co/Scvm5gb/image008.png" alt=""> </a> <br> 
        </center><br> <br>
        <button onclick="sendMail('Solicito ser Contactado 2 Play: Internet + Tv'); ;eventosLanding('Solicitud Informacion  2 Play: Internet + Tv'); return false;" class="btn bg-danger text-white col-12 mt-2"><h4>Contáctenme</h4></button>
        <br> <br> <br> 
        </div>     
    ...
    <div id="opt11" class="p-2 pl-3">
                        <div class="card">     
                            <div class="card-body">
                            <button onclick="Mens1();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://i.ibb.co/99R21bv/1-22.jpg"> <strong> </button> 
                            <button onclick="Mens2();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://i.ibb.co/FstbZ6X/2-22.jpg"> <strong> </strong> </button>
