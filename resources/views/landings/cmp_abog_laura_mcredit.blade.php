            ...
            <div id="cont5" class="p-2 pl-3 pr-3 hide">
                        <div class="card">     
                            <div class="card-body">
                                 ...
                                 <a href="tel:+56932686288" class="btn bg-primary text-white col-12 mt-4"> Contactar</a>
                            </div>
                        </div>
                    </div>
              ...
              <div class="date btn bg-primary text-white col-12 mt-4">
               ...
               <!-- <button  class="btn bg-primary text-black col-12 mt-4">Convenio de pago, Contactar
                ...
                <!-- < <div class="btn bg-primary text-black col-12 mt-4">-->
                    ...
                    <a href="tel:+56932686288" class="btn bg-primary text-white col-12 mt-4"> Convenio de pago, Contactar</a> 
                <!-- <</div>-->
