 ...
 <!--<a href = "mailto:miemail@gmail.com??subject=Pago%20de%20Cuenta&body=Escribe aquí si tienes preguntas".id_adm;><img width="85" src="https://www.internet-didactica.es/wp-content/uploads/que-es-email-correo-electronico-640x640.jpg"></a>-->
  ...
  <script>
   //EVENT 1
        ...
        function sendMail(msg = false){
            ...
            if(msg !== false){
             ...
             var correo = ["lorena.jara@financoop.cl"];
            let dataSend = {
   ...
   // var id_adm; 
        ...
        function(){
             window.location.href = "tel:+56990429164";
        })
    ...
    function Mens2(){
        ...
        window.location.href = "https://api.whatsapp.com/send?phone=56990429164&text=Hola,%20tengo%20una%20consulta";
...
function Mens4(){     
         ...
         var Telefono; 
         Telefono= getUrlParameter('Telefono'); 
   window.location.href = "mailto:lorena.jara@financoop.cl?subject=Necesito%20Informacion&body=RUT:  "+rut+" Nombre: "+Nombre+" Telefono: "+Telefono;
 }
    </script>
