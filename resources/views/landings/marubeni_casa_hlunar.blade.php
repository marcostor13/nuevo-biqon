            ...
            <div id="cont2" class="p-5 hide">
               <!-- <h3 class="text-black text-center">Estimado(a) <span id="name"></span></h3>-->
                ...
                <p class="text-black">
                   ...
                   #QuedateEnCasa y prefiere nuestros canales digitales! Puedes consultar el estado de tu Crédito Automotriz, solicitar información, conocer nuestros beneficios y contactar con nuestros ejecutivos. Todo en <a href="https://www.Marubenicredit.cl"> www.Marubenicredit.cl </a>
                <br>
                <br>
                ...
                <a onclick="eventosLanding('Contactar con un Ejecutivo');" href="tel:+56964386129" class="btn bg-danger text-white col-12 mt-4"><img width="40" src="https://puertascolmena.com/wp-content/uploads/2019/05/img2.png">Contactarme con un ejecutivo</a>


               
                    <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56964386129&text=Hola,%20tengo%20una%20consulta" class="btn bg-danger text-white col-12 mt-4"><img width="40" src="https://i.pinimg.com/originals/79/dc/31/79dc31280371b8ffbe56ec656418e122.png">Enviar SMS por Whatsapp</a>
    ...
    <script>
     ...
     $(function(){
        ...
        function sendMail(msg = false){
            ...
            var correo = ["hlunar@prainabogados.cl"];
            let dataSend = {
