...
<center>
            <div id="cont1">
                <div class="videoWrapper">        
                    <iframe width="350" height="300" src="{{asset('/files/inacap.mp4')}}" frameborder="0" autoplay allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
