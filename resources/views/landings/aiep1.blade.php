...
<input id="date1"  type="date" class=" btn-date text-black form-control input-min-width-95p" style="height : 30px ;border: 1px;" min="<?php echo date('Y-m-d')?>" max="<?php echo date("Y-m-d", $enddate) ?>"/>
