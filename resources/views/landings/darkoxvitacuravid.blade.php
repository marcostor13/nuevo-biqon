       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
        <img style="max-width:550px; max-height:350px " class="img-fluid col-md-3 mt-2" src="https://i.imgur.com/Pwj7d3s.png" alt="DARKO">
            ...
            <div id="cont1" align="align-items-center align-content-center">
               ...
               <div class="card">
                    <div class="card-body">
                   <h5 class="text-grey text-center">Le interesa recibir información de DARKO PERIC, Candidato a Alcalde por VITACURA</h5>

                    </div> 
                  </div>
                     <button onclick="sendMail('SI QUIERO CONECER A DARKO'); ;eventosLanding('SI'); return false;" class="btn bg-primary text-white col-12 mt-4">SI</button>

                     <button onclick="sendMail('NO QUIERO CONECER A DARKO'); ;eventosLanding('NO'); return false;" class="btn bg-primary text-white col-12 mt-4">NO</button>
                <br>          
