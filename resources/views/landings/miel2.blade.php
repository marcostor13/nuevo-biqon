       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
            ...
            <div id="cont1" class=" ">
                <div class="videoWrapper">        
                    <iframe width="400" height="320" src="{{asset('/files/wiluf2.mp4')}}" frameborder="0" autoplay allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <!-- <div class="card">     
                <div class="card-body">
        ...
        function sendMail(msg = false){
            ...
            $.post( "/sendMail", dataSend,function() {
                ...
                if(msg !== false){
                    ...
                    $('#message').text('Muchas Gracias. Su Solicitud Fue enviada a nuestra área. Nos pondremos en contacto con usted lo antes posible');
                }else{
                    $('#message').removeClass('hide');
