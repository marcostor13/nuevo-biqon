  ...
  background-image: 
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <div id="cont2" class="p-5 hide">
                ...
                <div class="d-flex justify-content-around align-content-center mt-4">
                    ...
                    <a onclick="eventosLanding('Llamar');" href="tel:+56959577379"><img width="40" src="https://img.icons8.com/wired/64/FFFFFF/phonelink-ring.png"></a>
                    <a onclick="eventosLanding('Correo');" href="mailto:ejecutivo@prainabogados.cl?subject=Landing%20Marubeni"><img width="40" src="https://img.icons8.com/ios-filled/50/FFFFFF/email.png"></a>
                </div>
    ...
    <script>
        ...
        function sendMail(msg = false){
            ...
            var correo = ["ejecutivo@prainabogados.cl"];
            let dataSend = {
