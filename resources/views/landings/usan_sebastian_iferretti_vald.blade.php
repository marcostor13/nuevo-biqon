  ...
  background-image: 
    ...
    <div id="USS" class="oscurecer" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;" >
      ...
      <option value="Trabajo Social" data-select2-id="25">Trabajo Social</option>
              ...
              <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56994400520&text=Hola,%20tengo%20una%20consulta" class="btn bg-danger text-white col-12 mt-4"><img width="30" src="https://i.pinimg.com/originals/6b/6f/95/6b6f9559658ad9c3d371977a674e2a56.png"> Contactanos</a>
   ...
   //EVENT 1
       $(function(){
        ...
        function sendMail(msg = false){
            ...
            var correo = ["italo.ferretti@uss.cl"];
            let dataSend = {
   ...
   window.location.href = "mailto:italo.ferretti@uss.cl?subject=Consulta%20Cursos%20Advance%20&body=Telefono:%20"+id_adm+"%20RUT:%20"+rut+" "+body_message;
