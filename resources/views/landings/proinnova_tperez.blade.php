        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <div id="cont5" class="p-2 pl-3 pr-3 hide">
                        <div class="card">     
                            <div class="card-body">
                                 ...
                                 <a href="tel:+56989064946" class="btn bg-primary text-black col-12 mt-4"> Contactar</a>
                            </div>
                        </div>
                    </div>
            <div id="cont2" class="p-5 hide">
                <h4 class="text-black text-center">Estimado(a) <span id="name"></span></h4>
                 ...
                 <p class="text-black">
                  Le Informamos que su deuda de: <strong>  Clínica Dávila S.P.A </strong> se encuentra en cobranza <span id="data1"></span>, por concepto de no pago. <br> Con el objeto de no proseguir con las acciones de cobranza, le ofrecemos las siguientes opciones:
                </p>
              ...
              <div class="date btn bg-primary text-black col-12 mt-4">
               ...
               <!-- <button  class="btn bg-primary text-black col-12 mt-4">Convenio de pago, Contactar
                ...
                <!-- < <div class="btn bg-primary text-black col-12 mt-4">-->
                    ...
                    <a href="tel:+56989064946" class="btn bg-primary text-black col-12 mt-4"> Convenio de pago, Contactar</a> 
                <!-- <</div>-->
               <!-- <button onclick='window.location.href="https://vtr.com/?pagoexpress=1"; eventosLanding("Pagina de Pagos"); ' class="btn bg-primary text-black col-12 mt-4">PAGAR AHORA</button>-->
                ...
                <div class="d-flex justify-content-around align-content-center mt-4">
                    ...
                    <a onclick="eventosLanding('Llamar');" href="tel:+56989064946"><img width="40" src="https://puertascolmena.com/wp-content/uploads/2019/05/img2.png"></a>
