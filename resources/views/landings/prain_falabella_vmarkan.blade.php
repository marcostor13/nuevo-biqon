...
.oscurecer {
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
            ...
            <div class=col-md-12>
                    ...
                    <div id="cont2" class="p-2 pl-3 pr-3 hide">
                      ...
                      <a onclick="eventosLanding('Llamar');" href="tel:+56994378883" class="btn bg-primary text-white col-12 mt-4">Llamar a Ejecutivo</a> 

                      <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56994378883&text=Hola,%20tengo%20una%20consulta"  class="date btn bg-primary text-white col-12 mt-4">Contactar por WhatsApp</a>  
  ...
  <script>
   ...
   // var id_adm; 
        ...
        function(){
             window.location.href = "tel:+56994378883";
        })
    ...
    var id_adm; 
       ...
       var id_adm; 
         ...
         var rut; 
         rut= getUrlParameter('rut'); 
   window.location.href = "mailto:vmarkan@prainabogados.cl?subject=Pago%20de%20Cuenta%20%20RUT:%20"+rut;
