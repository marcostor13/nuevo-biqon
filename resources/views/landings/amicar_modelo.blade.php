            ...
            <div id="cont1" class="p-3 ">
                ...
                <div class="card-body">
                 ...
                 <div class="d-flex justify-content-between">
                    ...
                    <div class="md-form col-6  m-0">
                      <input type="text" id="telefono" class="form-control" required placeholder="telefono">
                      <label for="form2"></label>
                    </div>
                    <div class="md-form col-6  m-0">
                 ...
                 <!-- <div class="md-form col-12 m-0">
                  ...
                  <div class="md-form col-12 m-0">
                    <input type="text" id="modelo" class="form-control" required placeholder="Indique el Modelo">
                    <label for="form2"></label>
                  </div> 
                  ...
                  <div class="text-center">
                    <hr>
                    <button class="btn bg-primary text-white col-12 mt-4" onclick="sendMail('El cliente solicito Informacion');eventosLanding('Solicitud Informacion Modelo'); return false;">Contactame</button>
