            ...
            <div id="cont2" class="p-3 ">
               ...
               <!-- <p class="text-white"> <h3>
                    8GB + 300 MIN + 100 SMS Desde $4.990 Oferta Limitada para Portabilidad Prepagos y Planes.
                      ...
                      <button onclick='activa();' class="btn bg-success text-white col-12 mt-2">VER DETALLES DE LA PROPIEDAD SUECIA 1</button>

                      <button onclick='activa1();' class="btn bg-success text-white col-12 mt-2">VER DETALLES DE LA PROPIEDAD HERMANOS CABOT 111 </button>
