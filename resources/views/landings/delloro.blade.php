  ...
  background-image: 
    ...
    <div id="DellOro" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            <img style="max-width:200px; max-height:200px " class="img-fluid col-10 col-md-3 mt-4" src="{{$landing->logo}}" alt="DellOro">
            ...
            <div id="cont5" class="p-2 pl-3 pr-3 hide">
                        <div class="card">     
                            <div class="card-body">
                                 ...
                                 <a href="tel:+56967688359" class="btn bg-danger text-white col-12 mt-4"> Contactar</a>
                            </div>
                        </div>
                    </div>
