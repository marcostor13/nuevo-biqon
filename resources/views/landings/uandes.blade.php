...
.opaco{
   ...
   <div id="UANDES" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;">
       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
            <img style="max-width: 60%" class="img-fluid col-md-3 mt-2" src="{{$landing->logo}}" alt="UANDES">
...
<div class="d-flex justify-content-around align-content-center mt-4"> 
                    ...
                    <a class="ml-4" onclick="eventosLanding('Correo');" href="mailto:mjsandovalg@uandes.cl?subject=Landing%20Video"><img width="60" src="https://es.seaicons.com/wp-content/uploads/2015/10/Email-icon.png"></a>
                </div>
        </div>
