...
.oscurecer {
 ...
 <img style="max-width: 100%" class="img-fluid col-md-3 mt-2" src="https://imgur.com/wqLNEMT.png" alt="UDALBA">
...
<img style="max-width:100%" class="img-fluid col-md-3 mt-2" src="{{$landing->logo}}" alt="UALBA">
            ...
            <a target="_blank" href="https://admision.udalba.cl/programas-advance2/" class="btn bg-danger text-white col-8 mt-4">Ir a la página web---->
              <i class="fas fa-graduation-cap ml-2"></i>
               ...
               <h3 class="text-black text-center">Estimado(a) <span id="name"> <?php echo $name; ?></span></h3>estudia una carrera profesional y obtén tu grado de Licenciado/a en Universidad del Alba (ex Pedro de Valdivia),
...
Becas y beneficios en matrícula y Arancel por toda la carrera
                  </h4>
