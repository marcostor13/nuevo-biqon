   ...
   <img style="height:180px; width:250px;" class="img-fluid col-md-6 mt-1 " src="https://i.imgur.com/Vp6VeXa.jpg" alt="HerediaAbogados">
            ...
            <div id="cont2" class="p-5 hide">
                ...
                <h5><p class="text-black"  align="justify">
                  Te informamos que el estado de tu causa conforme al art. 42 de la Ley de Concesiones, tramitada en el Jdo. Policía Local de La Granja ROL: <span id="data1"> es: <span id="data2">
                    <br>
