...
<div class="content container-fluid d-flex flex-column align-items-center justify-content-start">
    ...
    <div id="REYVOIP" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover; ">

        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
             <img style="max-width: 50%" class="img-fluid col-md-3 mt-2" src="{{$landing->logo}}" alt="REYVOIP">
      ...
      <div class="container">
       ...
       <div class="card-body ">
            ...
            SMS Campaigns <br> and Voice  <br> 
            100% Seguros 
            <!--<strong> Arriendo en La Serena y Coquimbo </strong>--> </h3> 
            <h3 class="text-black text-center">
             <strong> <br> Great bid Chile, Perú,   </strong> 
              <strong> <br>Colombia and Argentina  </strong> 
           </h3> 
             <!--  <hr class="hr-light">
   ...
   <div class="carousel-inner">
        <div class="item active">
            <img src="https://i.imgur.com/bOwqBIN.jpg1" alt="">
        </div>
        <div class="item">
            <img src="https://i.imgur.com/GT7Rvro.jpg1" alt="">
        </div>
        <div class="item">
            <img src="https://i.imgur.com/GM2COsl.jpg1" alt="">
        </div>
        <div class="item">
            <img src="https://i.imgur.com/zmMOH0H.jpg1" alt="">
        </div>
        <div class="item">
            <img src="https://i.imgur.com/ajWLQfD.jpg1" alt="">
        </div>
        <div class="item">
            <img src="https://i.imgur.com/k5BhXdB.jpg1" alt="">
        </div>
        <div class="item">
            <img src="https://i.imgur.com/ffFqOZV.jpg1" alt="">
        </div>
        <div class="item">
            <img src="https://i.imgur.com/2CHHy41.jpg1" alt="">
        </div>
        <div class="item">
            <img src="https://i.imgur.com/dWn1nBG.jpg1" alt="">
        </div>
        <div class="item">
            <img src="https://i.imgur.com/Ry5jv4g.jpg1" alt="">
        </div>
...
-->
                  <!-- <a onclick="eventosLanding('Llamar');" href="tel:+56996413264 "><img width="50" src="https://i.imgur.com/oqKGe5C.png"></a>-->
                    ...
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=972508713462&text=Hola,%20tengo%20una%20consulta"><img width="50" src="https://i.imgur.com/b1duJxb.png"></a>
