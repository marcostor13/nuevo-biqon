 ...
 <!--<a href = "mailto:miemail@gmail.com??subject=Pago%20de%20Cuenta&body=Escribe aquí si tienes preguntas".id_adm;><img width="85" src="https://www.internet-didactica.es/wp-content/uploads/que-es-email-correo-electronico-640x640.jpg"></a>-->
  ...
  <script>
   ...
   // var id_adm; 
        ...
        function(){
             window.location.href = "tel:+56961682615";
        })
    ...
    function Mens2(){
        ...
        window.location.href = "https://api.whatsapp.com/send?phone=56961682615&text=Hola,%20tengo%20una%20consulta";
...
function Mens4(){     
         ...
         var Telefono; 
         Telefono= getUrlParameter('Telefono'); 
   window.location.href = "mailto:laura.avila@financoop.cl?subject=Necesito%20Informacion&body=Nombre: "+Nombre+" Telefono: "+Telefono;
 }
    </script>
