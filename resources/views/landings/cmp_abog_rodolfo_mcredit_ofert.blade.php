  ...
  background-image: 
     ...
     <!-- <div id="CMPAbogados" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: contain; max-height:200px">-->
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <div id="cont5" class="p-2 pl-3 pr-3 hide">
                        <div class="card">     
                            <div class="card-body">
                                 ...
                                 <a href="tel:+56932245496" class="btn bg-primary text-black col-12 mt-4"> Contactar</a>
                            </div>
                        </div>
                    </div>
            <div id="cont2" class="p-5 hide">
                ...
                <p class="text-black">
                  Le Informamos que su deuda de: <strong>  MUNDO CREDITO  </strong> se encuentra en cobranza judicial, por concepto de no pago. <br> Disfruta de un <span id="data3"></span>% de descuento, por el valor de su prepago, antes <span id="data6"></span>, ahora <span id="data4"></span>, Válido hasta el 29/02/2020
              ...
              <div class="date btn bg-primary text-black col-12 mt-4">
               ...
               <!-- <button  class="btn bg-primary text-black col-12 mt-4">Convenio de pago, Contactar
                ...
                <!-- < <div class="btn bg-primary text-black col-12 mt-4">-->
                    ...
                    <a href="tel:+56932245496" class="btn bg-primary text-black col-12 mt-4"> Convenio de pago, Contactar</a> 
                <!-- <</div>-->
               <!-- <button onclick='window.location.href="https://vtr.com/?pagoexpress=1"; eventosLanding("Pagina de Pagos"); ' class="btn bg-primary text-black col-12 mt-4">PAGAR AHORA</button>-->
                ...
                <div class="d-flex justify-content-around align-content-center mt-4">
                    <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56932245496&text=Hola,%20tengo%20una%20consulta"><img width="40" src="https://i.pinimg.com/originals/6b/6f/95/6b6f9559658ad9c3d371977a674e2a56.png"></a>
                
                    <a onclick="eventosLanding('Llamar');" href="tel:+56932245496"><img width="40" src="https://puertascolmena.com/wp-content/uploads/2019/05/img2.png"></a>

                    <a onclick="eventosLanding('Correo');" href="mailto:rposada@cmpabogados.cl?subject=Landing%20CMP%20Abogados"><img width="40" src="https://www.internet-didactica.es/wp-content/uploads/que-es-email-correo-electronico-640x640.jpg"></a>
                </div>
   ...
   //EVENT 1
         ...
         function event1(){
            ...
            .done(function(e) {
                ...
                if(e.code == 200){
                    ...
                    $('#data6').text(getUrlParameter('data6'));
        ...
        function sendMail(msg = false){
            ...
            var correo = ["rposada@cmpabogados.cl"];  
            let dataSend = {
