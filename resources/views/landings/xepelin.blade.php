...
.oscurecer {
  background-image: 
    ...
    <div id="xepelin" class="oscurecer" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;" >
       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-80">
            ...
            <img style="max-width: 60%" class="img-fluid col-md-3 mt-2" src="https://www.xepelin.com/assets/img/logo.png" alt="xepelin">
            <img style="max-width: 60%" class="img-fluid col-md-3 mt-2" src="https://app.xepelin.com/static/media/logo-finmas.870a7c68.svg" alt="xepelin">
                ...
                <div class="card-body">
                 ...
                 <h4 class="dark-grey-text text-center">
                  ...
                  <div class="d-flex justify-content-between  m-0">
                    ...
                    <div class="md-form col-6  m-0">
                      <input type="text" id="apellido" class="form-control" required placeholder="Telefono">
                 ...
                 <div class="d-flex justify-content-between">
                    ...
                    <div class="md-form col-6  m-0">
                      <input type="text" id="rut" class="form-control" required placeholder="RUT Empresa">
                      <label for="form2"></label>
                    </div>
                    <div class="md-form col-6  m-0">
                      <input type="text" id="telefono" class="form-control" required placeholder="Nombre Empresa">
                      <label for="form2"></label>
                    </div>
                  </div> 
      ...
      <option value="Trabajo Social" data-select2-id="25">Trabajo Social</option>
                  ...
                  <div class="text-center">
                    <hr>
                    <button class="btn bg-danger text-white col-12 mt-4" onclick="sendMail('El cliente solicito Informacion');eventosLanding('Solicitud Informacion'); return false;">Registrarse</button>
 ...
 <a onclick="eventosLanding('Ir a Web');" href="https://www.xepelin.com/financiamiento.html" class="btn bg-danger text-white col-12 mt-4">Opciones de Financiamiento</a>
        ...
        function sendMail(msg = false){
            ...
            if(msg !== false){
                data = {
                    ...
                    'Nombre': $('#nombre').val(),
                    'Telefono': $('#apellido').val(),
                    'RUT Empresa': $('#rut').val(),
                    'Nombre Empresa': $('#telefono').val(),
                    'E-mail': $('#email').val(),
                    //'Sede': $('#sede').val(),
                   // 'Carrera': $('#carrera').val(),
   ...
   window.location.href = "mailto:claudia.garay@uss.cl?subject=Consulta%20Cursos%20Advance%20&body=Telefono:%20"+id_adm+"%20RUT:%20"+rut+" "+body_message;
