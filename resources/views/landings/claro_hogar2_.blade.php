    ...
    <div id="opt11" class="p-2 pl-3">
                        <div class="card">     
                            <div class="card-body">
                             ...
                             <button onclick="Mens2();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://imgur.com/0QBfzev.png"> <strong></strong> </button>
                             <button onclick="Mens3();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://imgur.com/VrCqlCS.png"> <strong> </strong> </button>
                            </div>
                        </div>
            </div>
</div>
...
<div class="card">     
    ...
    <div id="opt12" class="p-2 pl-3">
                        <div class="card">     
                            <div class="card-body">
                               <button onclick="Mens1();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://imgur.com/A6MezSN.png"> <strong> </strong> </button>
    ...
    <div id="opt11" class="p-2 pl-3">
                        <div class="card">     
                            <div class="card-body">
                            <button onclick="Mens1();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://imgur.com/A6MezSN.png"> <strong> </button> 
                            <button onclick="Mens2();" class="btn bg-white text-danger col-12 mt-2"><img width="300" src="https://imgur.com/0QBfzev.png"> <strong> </strong> </button>
