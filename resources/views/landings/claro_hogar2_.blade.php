                        ...
                        <!--<div class="card">     
                            <div class="card-body">-->
                               ...
                               <a onclick="Mens1();" class="btn bg-white text-danger col-12 mt-2"> <img class="col-12 mt-2" style="max-width:400px;" src="https://imgur.com/GWkleqW.png"></a> <br>
                                ...
                                <button onclick="sendMail('No deseo recibir Mas Noticias de Claro'); ;eventosLanding('No deseo Productos Claro'); return false;" class="btn bg-danger text-white col-4 mt-2"><h4>No deseo recibir Mas Mensajes de claro</h4></button>
