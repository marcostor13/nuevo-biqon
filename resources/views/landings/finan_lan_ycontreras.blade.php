 ...
 <!--<a href = "mailto:miemail@gmail.com??subject=Pago%20de%20Cuenta&body=Escribe aquí si tienes preguntas".id_adm;><img width="85" src="https://www.internet-didactica.es/wp-content/uploads/que-es-email-correo-electronico-640x640.jpg"></a>-->
  ...
  <script>
   //EVENT 1
        ...
        function sendMail(msg = false){
            ...
            if(msg !== false){
             ...
             var correo = ["yasna.contreras@financoop.cl"];
            let dataSend = {
   ...
   // var id_adm; 
        ...
        function(){
             window.location.href = "tel:+56957150770";
        })
    ...
    function Mens2(){
        ...
        window.location.href = "https://api.whatsapp.com/send?phone=56957150770&text=Hola,%20tengo%20una%20consulta";
