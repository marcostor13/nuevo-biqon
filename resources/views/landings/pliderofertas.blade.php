...
.oscurecer {
    ...
    linear-gradient(
      ...
      rgba(0, 0, 0, 0.5)
       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
            <img style="max-width: 40%" class="img-fluid col-md-3 mt-2" src="{{$landing->logo}}" alt="OFERTAS LIDER" width="500" height="1000">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="https://chocale.cl/wp-content/uploads/2019/02/mil-productos-a-mil-pesos-lider-feb-2019-1280x720.jpg" width="350" height="200"" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="https://na001.leafletcdns.com/cl/data/2/6779/0_s.jpg?t=1580136831" alt="Chicago">
    </div>

    <div class="item">
      <img src="https://na001.leafletcdns.com/cl/data/2/6672/0_s.jpg?t=1578906378" alt="New York">
    </div>
  </div>
