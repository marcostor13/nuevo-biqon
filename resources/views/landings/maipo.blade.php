  ...
  background-image: 
    linear-gradient(
     ...
     <div id="HerediaAbogados" class="oscurecer" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: 100% 100%;" >
        ...
        <!--<div class="opaco"></div>-->
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-5 w-100">
            <img style="max-width: 60%" class="img-fluid col-md-12 mt-1" src="{{$landing->logo}}" alt="HerediaAbogados">
