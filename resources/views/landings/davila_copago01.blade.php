                            ...
                            <div class="card-body">
                               ...
                               <!-- <button onclick="Mens();" class="btn bg-primary text-white col-12 mt-2">Contactar
                                ...
                                <!--<button onclick="sendMail('El cliente indica que ya pagó'); eventosLanding('Ya pagué'); return false;" class="btn bg-primary text-white col-12 mt-2">YA PAGUE 
                                    ...
                                    <a onclick="eventosLanding('Correo');" href="mailto:contactopago@davila.cl?subject=Landing%20Copago">Correo<img width="85" src="http://ojwgq1ostm42ulxuw45kfbt8-wpengine.netdna-ssl.com/hoosnetwork/wp-content/uploads/sites/30/2015/02/Email-image.jpg"></a>
                                    </div>
