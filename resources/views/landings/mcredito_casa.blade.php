...
<button onclick='window.location.href="http://servipag.mundocredito.cl/PagoCuotas.php"; eventosLanding("Pagina de Pagos");' class="btn bg-primary text-white col-12 mt-4">PAGAR AHORA</button>
         ...
         <button onclick="eventosLanding('Contactar con un Ejecutivo');" href="tel:+56967599345"></button>


               <div class="d-flex justify-content-around align-content-center mt-4"> 
                    <button onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56967599345&text=Hola,%20tengo%20una%20consulta"></button>
