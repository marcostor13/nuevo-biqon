            ...
            <div id="cont2" class="p-5 hide">
               <!-- <h3 class="text-black text-center">Estimado(a) <span id="name"></span></h3>-->
                ...
                <p class="text-black">
                   ...
                   #QuedateEnCasa y prefiere nuestros canales digitales! Puedes consultar el estado de tu Crédito Automotriz, solicitar información, conocer nuestros beneficios y contactar con nuestros ejecutivos. Todo en <a href="www.Mundocredito.cl"> www.Mundocredito.cl </a>
