  ...
  background-image: 
    ...
    <div id="USS" class="oscurecer" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;" >
       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
            <img style="max-width: 120%" class="img-fluid col-md-3 mt-2" src="{{$landing->logo}}" alt="USS">
...
<div id="cont1" class="p-3 ">
                ...
                <div class="card-body">
                  ...
                  <hr>
                   <center><a class="ml-4" onclick="eventosLanding('WHATSAPP');" href="https://api.whatsapp.com/send?phone=5698900 2595&text=Hola,%20tengo%20una%20consulta"><img width="50" src="https://i.imgur.com/zwRWdi8.png"></a> </center>
