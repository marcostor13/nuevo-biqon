                        ...
                        <div class="card">     
                            <div class="card-body">
                                <h3 class="text-grey text-center"> Estimado(a) <strong>   <span><?php echo $name; ?></span>  </strong> </h3>
                                 ...
                                 En estos momentos dificiles que estamos pasando a nivel pais en <strong class="text-primary">FINANCOOP</strong>, no queremos que salga de casa y hemos facilitado la forma en que puede acceder a un <strong> CréditoPre Aprobado</strong>.<strong class="text-primary">  Podemos ir a buscar los documentos a su casa.</strong>  Si desea información ingrese a las siguientes opciones:</h4> </p>
 ...
 <!--<a href = "mailto:miemail@gmail.com??subject=Pago%20de%20Cuenta&body=Escribe aquí si tienes preguntas".id_adm;><img width="85" src="https://www.internet-didactica.es/wp-content/uploads/que-es-email-correo-electronico-640x640.jpg"></a>-->
  ...
  <script>
   ...
   // var id_adm; 
        ...
        function(){
             window.location.href = "tel:+56964954428";
        })
    ...
    function Mens2(){
        ...
        window.location.href = "https://api.whatsapp.com/send?phone=56964954428&text=Hola,%20tengo%20una%20consulta";
         ...
         var Telefono; 
         Telefono= getUrlParameter('Telefono'); 
   window.location.href = "mailto:david.hormazabal@financoop.cl?subject=Necesito%20Informacion&body= Nombre: "+Nombre+" Telefono: "+Telefono;
 }
    </script>
