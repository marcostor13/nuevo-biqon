  ...
  background-image: 
    ...
    <div id="UDA" style=" /*background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;*/">
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
           <img style="max-width: 75%" class="img-fluid col-10 col-md-3 mt-4" src="{{$landing->logo}}" alt="UDA">-
...
<p class="text-white text-center"><br><strong>Seleccione alguna de estas opciones para comunicarse con un Ejecutivo quien podrá asesorarle y resolver sus consultas.</strong><br></p>
                    ...
                    <!-- <span class="text-white  text-center">Mi Cuenta<br>
                     <a class="ml-2" onclick="eventosLanding('Cuenta');" href="https://solvencia.cl/pagadeudas/"><img width="60" src="https://image.freepik.com/foto-gratis/lupa_172429-232.jpg"></a></span>
                         <span class="text-black bg-black text-center">WhatsApp<br>
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56983001247&text=Hola,%20tengo%20una%20consulta%20por%20Universidad%20de%20los%20Andes"><img width="50" src="https://i.imgur.com/86IRYB5.png"></a></span>
                ...
                <span class="text-white text-center">
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56975890470&text=Hola,%20tengo%20una%20consulta%20Universidad%20de%20los%20Andes"><img width="70" src="https://i.imgur.com/QcIC2T3.png"></a></span>
                        <span class="text-white text-center">
                    ...
                    <a class="ml-2" onclick="eventosLanding('Correo');" href="mailto:contacto@solvencia.cl"><img width="70" src="https://i.imgur.com/2YlOrMQ.png"></a></span>
                     <span class="text-white text-center">
                <a class="ml-2" onclick="eventosLanding('Pago en Línea');" href="https://www.pentafinanciero.cl/"> <img width="70" src="https://i.imgur.com/425rNaE.png"></a></span>
                </div>-->

                <span class="text-white text-center">
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56975890470&text=Hola,%20tengo%20una%20consulta%20Penta%20Financiero"><img width="70" src="https://i.imgur.com/ot39iWI.png"></a></span>
                        <span class="text-white text-center">
                    <a class="ml-2" onclick="eventosLanding('Llamar');" href="tel:+56975890461"><img width="70" src="https://i.imgur.com/sN7X4XZ.png"></a></span>
                        <span class="text-white text-center">
                    <a class="ml-2" onclick="eventosLanding('Correo');" href="mailto:contacto@solvencia.cl"><img width="70" src="https://i.imgur.com/yedwmQG.png"></a></span>
                     <span class="text-white text-center">
                <a class="ml-2" onclick="eventosLanding('Pago en Línea');" href="https://www.pentafinanciero.cl/"> <img width="70" src="https://i.imgur.com/TI8UBph.png"></a></span>
                </div>
                <br><br>
