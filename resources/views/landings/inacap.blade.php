...
.oscurecer {
  background-image: 
    ...
    <div id="INACAP" style=" /*background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;*/">

        <div class="opaco"></div>

        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
           <img style="max-width: 50%" class="img-fluid col-10 col-md-3 mt-4" src="{{$landing->logo}}" alt="INACAP">-
...
<p class="text-white text-center"><br><strong>Seleccione alguna de estas opciones para comunicarse con un ejecutivo quien podrá asesorarle y resolver su consulta</strong></p>
                    ...
                    <!-- <span class="text-white  text-center">Mi Cuenta<br>
                     <a class="ml-2" onclick="eventosLanding('Cuenta');" href="https://solvencia.cl/pagadeudas/"><img width="60" src="https://image.freepik.com/foto-gratis/lupa_172429-232.jpg"></a></span>nger
                         <span class="text-danger  text-center">WhatsApp<br>
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56983001247&text=Hola,%20tengo%20una%20consulta%20por%20deuda%20INACAP"><img width="50" src="https://i.imgur.com/86IRYB5.png"></a></span>
                ...
                <span class="text-warning  text-center">
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56983001247&text=Hola,%20tengo%20una%20consulta%20por%20deuda%20INACAP"><img width="70" src="https://i.imgur.com/j3Cpxva.png"></a></span>
                       <span class="text-warning  text-center">
