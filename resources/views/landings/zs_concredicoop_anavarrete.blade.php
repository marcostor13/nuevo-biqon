        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <div id="cont5" class="p-2 pl-3 pr-3 hide">
              ...
              <div id="cont2" class="p-5 hide">
                <h3 class="text-black text-center"><span id="name"></span></h3>

                  <p class="text-black" align="text-center">
                   Nos es grato informar que hoy su operación con origen Concredicoop está siendo administrada por Financoop, manteniendo sus actuales condiciones comerciales y otorgando un servicio de calidad, quedando atentos a cualquier consulta o producto crediticio que usted requiera, previa evaluación del área de riesgo. 
<br>
 <br>

Según nuestros registros el crédito otorgado por Concredicoop se encuentra moroso, por eso estamos intentando contactarlo para poder regularizar y resolver esta situación. <br></p>
   ...
   //EVENT 1
        ...
        function sendMail(msg = false){
            ...
            var correo = ["cobranzasfinancoop@zonasursa.cl"];  
 ...
 /*  window.location.href = "https://ww3.servipag.com/pagoenlinea/portal/desktop/public/todas/!ut/p/b1/04_Sj9CPykssy0xPLMnMz0vMAfGjzOKNgs0CLZ0MHQ38zQPcDBx9gs1CzAK9Df0DTYAKIvEo8DanTL-HEXH6DXAARwNC-r30o9Jz8pOAXg3Xj8KrGOQXvApAjgUrwOMaP4_83FT9gtzQ0IjKYE9dR0VFADNEynw!/dl4/d5/L2dBISEvZ0FBIS9nQSEh/?idServicio=34&idBiller=843?TELEFONO=985296912&ID=79849235&URL=https://ww3.servipag.com/pagoenlinea/portal/desktop/public/todas/!ut/p/b1/04_Sj9CPykssy0xPLMnMz0vMAfGjzOKNgs0CLZ0MHQ38zQPcDBx9gs1CzAK9Df0DTYAKIvEo8DanTL-HEXH6DXAARwNC-r30o9Jz8pOAXg3Xj8KrGOQXvApAjgUrwOMaP4_83FT9gtzQ0IjKYE9dR0VFADNEynw!/dl4/d5/L2dBISEvZ0FBIS9nQSEh/?idServicio=34&idBiller=843";*/
     ...
     window.location.href = "http://servipag.mundocredito.cl/PagoCuotas.php";
    ...
    function Mens3(){
        ...
        window.location.href = "https://api.whatsapp.com/send?phone=56977170836&text=Hola,%20tengo%20una%20consulta";
    
        } 

           function Mens2(){

        window.location.href ="tel:+56977170836";
