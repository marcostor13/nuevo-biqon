   ...
   <!-- <div id="simple" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;">-->
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <div id="opt1" class="p-2 pl-3">
                        <div class="card">     
                            <div class="card-body">
                               <button onclick="Mens1();" class="btn bg-white text-danger col-12 mt-2"><img width="80" src="https://i.imgur.com/9hoo6Uk.png"> <strong>   1 Play: Internet </strong> </button>
                               <button onclick="Mens2();" class="btn bg-white text-danger col-12 mt-2"><img width="80" src="https://i.imgur.com/B9n98KE.png"> <strong>  2 Play: Internet + Tv</strong> </button>
                               <button onclick="Mens3();" class="btn bg-white text-danger col-12 mt-2"><img width="80" src="https://i.imgur.com/fDpn2k2.png"> <strong>  3 Play: Internet + Tv + Telefonía</strong> </button>
                            </div>
                        </div>
            </div>
