            ...
            <div id="opt1" class="p-2 pl-3">
                        <!--<div class="card">     
                            <div class="card-body">-->
                               ...
                               <a onclick="Mens1();" class="btn bg-white text-danger col-4 mt-2"> <img class="col-3 mt-2" style="max-width:200px;" src="https://i.imgur.com/4YQmkVw.png"></a>
                                <a onclick="Mens2();" class="btn bg-white text-danger col-4 mt-2"> <img class="col-3 mt-2" style="max-width:200px;" src="https://i.imgur.com/xGMS3O2.png"></a>
                                <a onclick="Mens2();" class="btn bg-white text-danger col-4 mt-2"> <img class="col-3 mt-2" style="max-width:200px;" src="https://i.imgur.com/oGSlWts.png"></a>
