...
.oscurecer {
 ...
 <!--   <div id="ZonaSur" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;">-->
...
#EstamosJuntosEnEsto
                ...
                <button onclick="sendMail('El cliente indica que ya pagó'); eventosLanding('Ya pagué'); return false;" class="btn bg-success text-white col-12 mt-2">YA PAGUE</button>
                 ...
                 <button class="btn bg-success text-white col-12 mt-2" onclick="sendMail('El cliente solicito que contactarse');eventosLanding('Solicitud Contactarse');">AGENTAR CONTACTO</button>
   ...
   //EVENT 1
      $(function(){
        ...
        function sendMail(msg = false){
            ...
            var correo = ["jesus.binteraction@gmail.com", "arojas@zonasursa.cl"];  
            let dataSend = {
