  ...
  background-image: 
           ...
           <div id="cont1" class="p-5 ">
             ...
             <div id="cont2" class="p-3 hide">
                ...
                <div class="d-flex justify-content-around align-content-center mt-4"> 
                    ...
                    <a onclick="eventosLanding('Correo');" href="mailto: daniela.larrondo@financoop.cl?subject=Solicito%20Informacion"><img width="40" src="https://es.seaicons.com/wp-content/uploads/2015/10/Email-icon.png"></a>
                </div>
               </div>  
   ...
   //EVENT 1
        ...
        function sendMail(msg = false){
            ...
            var correo = ["daniela.larrondo@financoop.cl"];
            let dataSend = {
