  ...
  background-image: 
    ...
    <div  >
       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-80">
            ...
            <img style="max-width: 80%" class="img-fluid col-md-3 mt-2" src="https://imgur.com/QG9Npsy.jpg" alt="USS">
              ...
              <div id="cont5" class="p-2 pl-3 pr-3 hide">
                ...
                <div class="card-body">
                 ...
                 <div class="text-center">
                    <hr>
                    <button class="btn btn-danger text-white col-12 mt-4" onclick="sendMail('El cliente solicito Informacion');eventosLanding('Solicitud Informacion'); return false;">Solicitar Inscripción</button>
