    ...
    <div id="ProInnova" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: contain; max-height:200px">
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <div id="cont2" class="p-5 hide">
                ...
                <p class="text-black">
                  Le Informamos que su deuda de: <strong> ISAPRE COLMENA GOLDEN CROSS S.A. </strong> se encuentra en cobranza <span id="data1"></span>, por concepto de no pago. <br> Con el objeto de no proseguir con las acciones de cobranza, le ofrecemos las siguientes opciones:
                </p>
