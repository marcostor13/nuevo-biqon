  ...
  background-image: 
   ...
   .input-min-width-95p {min-height:5%;}
       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
           <img style="max-width:250px; max-height:150px " class="img-fluid col-md-3 mt-2" src="{{$landing->logo}}" alt="natalia">
           <!--<img style="max-width:250px; max-height:350px "  class="img-fluid col-md-3 mt-2" src="https://i.imgur.com/THwO9dr.png" alt="Jacqueline">-->
            ...
            <div id="cont1" align="align-items-center align-content-center">
               ...
               <div class="card">
                    <div class="card-body">
                   <h5 class="text-grey text-center">Le interesa recibir información de Natalia Castillo</h5>

                    </div> 
                  </div>
                     <button onclick="sendMail('SI QUIERO CONECER A NATALIA'); ;eventosLanding('SI'); return false;" class="btn bg-primary text-white col-12 mt-4">SI</button>

                     <button onclick="sendMail('NO QUIERO CONECER A NATALIA'); ;eventosLanding('NO'); return false;" class="btn bg-primary text-white col-12 mt-4">NO</button>
                <br>
                <br>
