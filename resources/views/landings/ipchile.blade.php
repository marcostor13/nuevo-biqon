...
<hr>
                <p class="text-black text-center">
                   Instituto profesional IPCHILE, recuerda que usted mantiene una deuda por regularizar.<br>
...
<p class="text-white text-center">Selecciona alguna de estas opciones para comunicarte con un ejecutivo quien podrá asesorarle y resolver su consulta</p>
                    ...
                    <span class="text-warning  text-center">Pago en Linea<br>
                     <a class="ml-2" onclick="eventosLanding('Pago en Linea');" href="https://portal.ipchile.cl/"><img width="50" src="https://img.freepik.com/free-vector/plain-credit-card-concept-illustration_114360-199.jpg?size=338&ext=jpg"></a></span>
                </div>
                <br><br>
