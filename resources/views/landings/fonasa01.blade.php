...
.oscurecer {
  background-image: 
   ...
   <img style="height:450px; width:450px;" class="img-fluid col-md-6 mt-1" src="https://imgur.com/ZDMeG2k.jpeg" alt="HerediaAbogados">
...
<p class="text-white text-center"><br><strong>Seleccione alguna de estas opciones para comunicarte con un ejecutivo quien podrá asesorarle y resolver su consulta</strong></p>
                ...
                <span class="text-white text-center">
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56975890453&text=Hola,%20tengo%20una%20consulta%20IPCHILE"><img width="70" src="https://imgur.com/ExaoDvT.png"></a></span>
                        <span class="text-white text-center">
