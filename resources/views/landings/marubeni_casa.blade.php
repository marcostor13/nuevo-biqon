            ...
            <div id="cont2" class="p-5 hide">
               <!-- <h3 class="text-black text-center">Estimado(a) <span id="name"></span></h3>-->
                ...
                <p class="text-black">
                   ...
                   #QuedateEnCasa y prefiere nuestros canales digitales! Puedes consultar el estado de tu Crédito Automotriz, solicitar información, conocer nuestros beneficios y contactar con nuestros ejecutivos. Todo en <a href="www.Marubenicredit.cl"> www.Marubenicredit.cl </a>
                <br>
                <br>
                ...
                <a onclick="eventosLanding('Contactar con un Ejecutivo');" href="tel:+56967599345" class="btn bg-danger text-white col-12 mt-4"><img width="40" src="https://puertascolmena.com/wp-content/uploads/2019/05/img2.png">Contactar Ejecutivo</a>
