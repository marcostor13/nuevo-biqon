        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
          ...
          <div style="background-color: #54C86B">
            ...
            <div  id="cont7" class="p-2 pl-3 pr-3"> <center>
              ...
              -->  <!-- <a href="https://pagorapido.cmr.cl/" class="btn bg-success text-white col-12 mt-4"> PAGAR </a>-->

               <button onclick='window.location.href="https://pagorapido.cmr.cl/"; eventosLanding("Pagina de Pagos"); ' class="btn bg-success text-white col-12 mt-4">PAGAR AHORA</button>
           </center>
           <br> <br>
