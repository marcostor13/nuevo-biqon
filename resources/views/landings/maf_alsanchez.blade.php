...
?>
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <div id="cont2" class="p-3 ">
                ...
                <div class="date btn bg-danger text-white col-12 mt-4">
                    ...
                    <input id="date1"  type="date" class="btn-date text-danger" style="border: none;" min="<?php echo date('Y-m-d') ?>" max="<?php echo date("2020-04-03", $enddate) ?>"/>
                </div>
               <!-- <button onclick='window.location.href="https://www.mafchile.com/client/login";eventosLanding("Pagina de Pagos");' class="btn bg-danger text-white col-12 mt-4">PAGAR AHORA</button>--><
                ...
                <div class="d-flex justify-content-around align-content-center mt-4 ">
                    <br>
                    <br>
                    <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56967599342&text=Hola,%20tengo%20una%20consulta"><img width="40" src="https://img.icons8.com/ios-filled/50/FFFFFF/whatsapp.png"></a>
                    <a onclick="eventosLanding('Llamar');" href="tel:+56967599342"><img width="40" src="https://img.icons8.com/wired/64/FFFFFF/phonelink-ring.png"></a>
    ...
    <script>
        ...
        function sendMail(msg = false){
           ...
           var correo = ["maf@prainabogados.cl","alsanchez@prainabogados.cl "];
            let dataSend = {
