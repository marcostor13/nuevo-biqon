            ...
            <div id="cont1" class="p-3 ">
                ...
                <div class="card-body">
                 ...
                 <h4 class="text-white text-center">
                    <strong>Consulta por tus Becas de Matricula anticipadas para Octubre 2020</strong>
                  </h4>
                  <hr>
...
<option value="Licenciatura en Trabajo Social">Licenciatura en Trabajo Social</option>
              ...
              <button class="btn bg-primary text-white col-10 mt-4" onclick="sendMail('El cliente solicito Informacion');eventosLanding('Solicitud Informacion'); return false;"> Quiero saber mas</button>
               ...
               <div class="text-center">
              <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56968317243&text=Hola,%20tengo%20una%20consulta" class="btn bg-primary text-white col-10 mt-4"><img width="30" src="https://i.pinimg.com/originals/6b/6f/95/6b6f9559658ad9c3d371977a674e2a56.png"> Contactanos</a>
   ...
   //EVENT 1
       $(function(){
        ...
        function sendMail(msg = false){
            ...
            var correo =["patricia.medina@ugm.cl"];
            let dataSend = {
   ...
   window.location.href = "mailto:patricia.medina@ugm.cl?subject=Consulta%20Cursos%20Advance%20&body=Telefono:%20"+id_adm+"%20RUT:%20"+rut+" "+body_message;
