    ...
    <div id="VTR" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: contain; max-height:200px">
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <div id="cont2" class="p-5 hide">
                ...
                <button onclick='window.location.href="https://vtr.com/productos/reclamos"; eventosLanding("Pagina de Pagos"); ' class="btn bg-danger text-black col-5 mt-3">REPORTAR ABUSO</button>

                <button onclick='window.location.href="http://centrodeayudaonline.vtr.com/autoatencion/conocer-sucursal-virtual/"; eventosLanding("Actualiza Datos"); ' class="btn bg-danger text-black col-5 mt-3">ACTUALIZA LOS DATOS</button>

                <button onclick='window.location.href="https://vtr.com/productos/privacidad"; eventosLanding("Privacidad"); ' class="btn bg-danger text-black col-5 mt-3">PRIVACIDAD</button>
