...
<p class="text-white text-center">Selecciona alguna de estas opciones para comunicarte con un ejecutivo quien podrá asesorarle y resolver su consulta</p>
                ...
                <button onclick='window.location.href="http://www2.duoc.cl/portal-de-pagos-en-linea"; eventosLanding("PAGINA DE PAGOS"); ' class="btn bg-warning text-black col-12 mt-2"> <img width="30" src="https://img.freepik.com/free-vector/plain-credit-card-concept-illustration_114360-199.jpg?size=338&ext=jpg"> PAGO EN LINEA</button>
