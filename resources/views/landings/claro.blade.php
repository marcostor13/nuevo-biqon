                        ...
                        <div class="card">     
                            <div class="card-body">
                               ...
                               <button onclick="Mens1();" class="btn bg-primary text-white col-12 mt-2">PAGAR
                                ...
                                <div class="d-flex justify-content-around align-content-center mt-4">
                                    <a onclick='window.location.href = "https://accesorios.clarochile.cl/"'>ACCESORIOS
                                    <img width="150" src="https://i.imgur.com/2MYzfWg.png"></a>
                                </div>
                                
                                <div class="d-flex justify-content-around align-content-center mt-4">
                                                       
                                    <a onclick='window.location.href = "https://www.clarochile.cl/personas/servicios/servicios-moviles/prepago/" '><img width="85" src="https://puertascolmena.com/wp-content/uploads/2019/05/img2.png">Movil</a>
