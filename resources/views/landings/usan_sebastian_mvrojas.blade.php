  ...
  background-image: 
    ...
    <div id="USS" class="oscurecer" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;" >
       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-80">
            ...
            <img style="max-width: 100%" class="img-fluid col-md-3 mt-2" src="https://www.advance.uss.cl/wp-content/themes/uss/img/logo-uss-advance.png" alt="USS">
      ...
      <option value="Trabajo Social" data-select2-id="25">Trabajo Social</option>
              ...
              <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56956889198&text=Hola,%20tengo%20una%20consulta" class="btn bg-danger text-white col-12 mt-4"><img width="10" src="https://i.pinimg.com/originals/6b/6f/95/6b6f9559658ad9c3d371977a674e2a56.png">Contactanos</a>
            
              <a onclick="eventosLanding('Correo');" href="mailto: mariavictoria.rojas@uss.cl?subject=Landing%20USS" class="btn bg-danger text-white col-12 mt-4"><img width="10" src="https://es.seaicons.com/wp-content/uploads/2015/10/Email-icon.png">Escríbenos</a>
