           ...
           <div id="cont1" class="p-5 hide">
             ...
             <div id="cont2" class="p-3">
                ...
                <div class="card-body">
                        ...
                        <img width="250" height="200" src="https://www.financoop.cl/wp-content/uploads/2020/03/MG_0075-copy_MG_0075-copy.jpg">
                         </div>
                ...
                <button onclick='window.location.href="tel:+800835220" 'class="btn bg-warning text-black col-12 mt-4">CONSULTAS</button>
               ...
               <!-- <button onclick="sendMail('El cliente indica que desea ser contactado'); eventosLanding('contacto'); return false;" class="btn bg-warning text-black col-12 mt-4">CLICK AQUÍ SI DESEAS QUE TE CONTACTEMOS</button>-->
                ...
                <div class="d-flex justify-content-around align-content-center mt-4"> 
                   <!-- <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56963101244&text=Hola,%20tengo%20una%20consulta"><img width="40" src="https://i.pinimg.com/originals/6b/6f/95/6b6f9559658ad9c3d371977a674e2a56.png"></a>-->
                    ...
                    <a onclick="eventosLanding('Llamar');" href="tel:+800835220"><img width="40" src="https://i.imgur.com/Oh5DCRW.png"></a>
                   
                    <a onclick="eventosLanding('Correo');" href="mailto: jesus.binteraction@gmail.com"><img width="40" src="https://es.seaicons.com/wp-content/uploads/2015/10/Email-icon.png"></a>
                </div>
