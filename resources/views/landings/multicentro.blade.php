  ...
  background-image: 
   ...
   <!-- <div id="CMPAbogados" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: contain; max-height:200px">-->
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            <img style="max-width:300px; max-height:250px " class="img-fluid col-10 col-md-3 mt-4" src="{{$landing->logo}}" alt="Multicentro">
            ...
            <div id="cont2" class="p-5 hide">
                ...
                <p class="text-black">
                  Le Informamos que su deuda de: <strong> Multicentro</strong> se encuentra en cobranza judicial, por concepto de no pago. <br> Con el objeto de no proseguir con las acciones judiciales, le ofrecemos las siguientes opciones:
                </p>
              ...
              <div class="date btn bg-danger text-white col-12 mt-4">
               ...
               <!-- <button onclick='window.location.href="https://vtr.com/?pagoexpress=1"; eventosLanding("Pagina de Pagos"); ' class="btn bg-primary text-black col-12 mt-4">PAGAR AHORA</button>-->
                ...
                <div class="d-flex justify-content-around align-content-center mt-4">
                    ...
                    <a onclick="eventosLanding('Correo');" href="mailto:eduardo.binteraction@gmail.com?subject=Landing%20Multicentro"><img width="40" src="https://www.internet-didactica.es/wp-content/uploads/que-es-email-correo-electronico-640x640.jpg"></a>
                </div>
