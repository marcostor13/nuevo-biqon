  ...
  background-image: 
    ...
    <div id="UANDES" style=" /*background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;*/">
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
           <img style="max-width: 50%" class="img-fluid col-10 col-md-3 mt-4" src="{{$landing->logo}}" alt="CPECH">-
...
Le invitamos a contactarse a la brevedad para ser informado de los métodos de pago disponibles. 
                 ...
                 <div class="mt-2 text-center" style="background:#2c50ff;"> 
<p class="text-white text-center"><br><strong>Seleccione alguna de estas opciones para comunicarse con un ejecutivo quien podrá asesorarle y resolver su consulta</strong></p>
                    ...
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56983001247&text=Hola,%20tengo%20una%20consulta%20por%20deuda%20CPECH"><img width="50" src="https://i.imgur.com/86IRYB5.png"></a></span>
                    ...
                    <span class="text-white  text-center">Pago en Línea<br>
                     <a class="ml-2" onclick="eventosLanding('Pago en Línea');" href="https://portal.cepech.cl/gnr/gnrPagos2PR_TA.ASP?ee=1"><img width="50" src="https://i.imgur.com/2YPpKWm.png"></a></span>
                </div>-->

                 <span class="text-white text-center">
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56983001247&text=Hola,%20tengo%20una%20consulta%20por%20deuda%20CPECH"><img width="70" src="https://i.imgur.com/kzyuhVO.png"></a></span>
                        <span class="text-white text-center">
                    ...
                    <a class="ml-2" onclick="eventosLanding('Correo');" href="mailto:contacto@solvencia.cl"><img width="70" src="https://i.imgur.com/h7UKcOG.png"></a></span>
                     <span class="text-white text-center">
                <a class="ml-2" onclick="eventosLanding('Pago en Línea');" href="https://portal.cepech.cl/gnr/gnrPagos2PR_TA.ASP?ee=1"> <img width="70" src="https://i.imgur.com/HEnso4V.png"></a></span>
                </div>
                <br><br>
