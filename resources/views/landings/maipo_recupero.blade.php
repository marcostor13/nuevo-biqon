...
.oscurecer {
  background-image: 
   ...
   <img style="height:180px; width:250px;" class="img-fluid col-md-6 mt-1 " src="https://i.imgur.com/NtCuzJ2.jpg" alt="HerediaAbogados">
            ...
            <div id="cont2" class="p-5 hide">
                ...
                <h5><p class="text-black" align="justify">
                  Te informamos que queremos lograr un acuerdo extrajudicial respecto de los daños provocados a Ruta del Maipo Sociedad Concesionaria en el accidente de fecha <span id="data1"></span>/04/2020 
                    <br>
