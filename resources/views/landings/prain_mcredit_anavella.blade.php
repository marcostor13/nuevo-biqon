            ...
            <div id="cont2" class="p-5 hide">
                ...
                <p class="text-black">  
                    ...
                    <br>
                      ...
                      <a onclick="eventosLanding('Llamar');" href="tel:+56964386129" class="btn bg-primary text-white col-12 mt-4">Llamar a Ejecutivo</a> 

                      <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56964386129&text=Hola,%20tengo%20una%20consulta"  class="date btn bg-primary text-white col-12 mt-4">Contactar por WhatsApp</a>  
