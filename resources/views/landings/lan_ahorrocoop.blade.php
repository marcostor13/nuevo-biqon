...
.oscurecer {
  background-image: 
   ...
   <!--<div id="Ahorrocoop" class="oscurecer" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;" >-->

        
        <div class="opaco"></div>

       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
            <img  class="img-fluid col-md-3 mt-1" src="{{$landing->logo}}" alt="Ahorrocoop">
           ...
           <div id="cont1" class="p-3 ">
             ...
             <div id="cont2" class="p-0 hide">
                ...
                <button onclick='window.location.href="tel:+56974552290" 'class="btn bg-danger text-white col-12 mt-4">CONSULTAS</button>

               <button onclick="sendMail('El cliente indica que desea ser contactado'); eventosLanding('contacto'); return false;" class="btn bg-danger text-white col-12 mt-3">  DESEAS QUE TE CONTACTEMOS </button>

                

                <div class="d-flex justify-content-around align-content-center mt-4"> 
                    <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56974552290&text=Hola,%20tengo%20una%20consulta"><img width="40" src="https://i.pinimg.com/originals/6b/6f/95/6b6f9559658ad9c3d371977a674e2a56.png"></a>
