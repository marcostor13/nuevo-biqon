...
<p class="text-white text-center"><strong>Seleccione alguna de estas opciones para comunicarse con un ejecutivo quien podrá asesorarle y resolver su consulta</strong><br></p>
                    ...
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56941397476&text=Hola,%20tengo%20una%20consulta%20por%20UDLA"><img width="70" src="https://i.imgur.com/j3Cpxva.png"></a></span>
                       <span class="text-warning  text-center">
   ...
   //EVENT 1
        ...
        function sendMail(msg = false){
            ...
            var correo = ["contacto@globalcobro.cl"];
            let dataSend = {
