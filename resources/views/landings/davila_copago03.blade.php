    ...
    <div id="CLINICA_DAVILA" class="oscurecer" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;" >
     ...
     <div class="opaco">
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
            <img style="max-width: 75%" class="img-fluid col-md-4 mt-2" src="{{$landing->logo}}" alt="CLINICA_DAVILA">
          <br>
            <div class=col-md-12>
                        ...
                        <div class="card">     
                            <div class="card-body">
                                <h4 class="text-grey text-center"> Estimado(a) <strong> Paciente <!-- <span id="name"></span> --></strong> </h4>
                                 ...
                                 Para regularizar su cuenta pendiente, lo invitamos a utilizar la modalidad de pago en línea, en la web de Clinica Davila, seleccionando la opción PAGAR.</h5> </p>
