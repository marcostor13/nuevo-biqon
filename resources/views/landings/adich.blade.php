...
.oscurecer {
    ...
    linear-gradient(
     ...
     <!-- <div id="CMPAbogados" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: contain; max-height:200px">-->
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
             <img style="max-width:350px; max-height:220px" class="img-fluid col-md-3 mt-2" src="{{$landing->logo}}" alt="ZONASUR">
            ...
            <div id="cont2" class="p-5 hide">
               ...
               <p class="text-black" align="text-center">
                    Le recordamos que usted tiene una solicitud de hora médica en Nuestra Asociacion,  con el Dr <strong> BINTERACTION CHILE </strong> para el día <?php echo date("d-m-Y", $enddate) ?> a las 15:00 Hrs
               ...
               <button onclick="sendMail('ASISTIRE A MI HORA'); ;eventosLanding('SI'); return false;" class="btn bg-primary text-white col-12 mt-4">SI</button>
                ...
                <button onclick="sendMail('NO PODRE ASISTIR A LA HORA AGENDADA'); ;eventosLanding('NO'); return false;" class="btn bg-primary text-white col-12 mt-4">NO</button>

                <button onclick='window.location.href="tel:+56226780500"; eventosLanding("Contacto");' class="btn bg-primary text-white col-12 mt-4">Contactenos</button>
             </div>
 ...
 /*  window.location.href = "https://ww3.servipag.com/pagoenlinea/portal/desktop/public/todas/!ut/p/b1/04_Sj9CPykssy0xPLMnMz0vMAfGjzOKNgs0CLZ0MHQ38zQPcDBx9gs1CzAK9Df0DTYAKIvEo8DanTL-HEXH6DXAARwNC-r30o9Jz8pOAXg3Xj8KrGOQXvApAjgUrwOMaP4_83FT9gtzQ0IjKYE9dR0VFADNEynw!/dl4/d5/L2dBISEvZ0FBIS9nQSEh/?idServicio=34&idBiller=843?TELEFONO=985296912&ID=79849235&URL=https://ww3.servipag.com/pagoenlinea/portal/desktop/public/todas/!ut/p/b1/04_Sj9CPykssy0xPLMnMz0vMAfGjzOKNgs0CLZ0MHQ38zQPcDBx9gs1CzAK9Df0DTYAKIvEo8DanTL-HEXH6DXAARwNC-r30o9Jz8pOAXg3Xj8KrGOQXvApAjgUrwOMaP4_83FT9gtzQ0IjKYE9dR0VFADNEynw!/dl4/d5/L2dBISEvZ0FBIS9nQSEh/?idServicio=34&idBiller=843";*/
    ...
    function Mens3(){
        ...
        window.location.href = "https://api.whatsapp.com/send?phone=56939452830&text=Hola,%20tengo%20una%20consulta";
    
        } 

           function Mens2(){

        window.location.href ="tel:+56939452830";
