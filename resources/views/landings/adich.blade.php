        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
            ...
            <div id="cont2" class="p-5 ">
               ...
               <p class="text-black" align="text-center">
                    Le recordamos que usted tiene una solicitud de hora médica en Nuestra Asociacion,  con el Dr <strong> Nombre_DoctorR </strong> para el día <?php echo date("d-m-Y", $enddate) ?> a las 03:00 PM
