...
.oscurecer {
  background-image: 
    ...
    <div id="PMG" style=" /*background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;*/">

        <div class="opaco"></div>

        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
           <img style="max-width: 65%" class="img-fluid col-10 col-md-3 mt-4" src="{{$landing->logo}}" alt="PGM">-
...
<p class="text-white text-center"><strong>Seleccione alguna de estas opciones para comunicarse con un ejecutivo quien podrá asesorarle y resolver su consulta</strong><br></p>
                    ...
                    <a class="ml-2" onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56975890470&text=Hola,%20tengo%20una%20consulta%20por%20PGM"><img width="70" src="https://i.imgur.com/j3Cpxva.png"></a></span>
                       <span class="text-warning  text-center">
                    ...
                    <span class="text-warning  text-center">
                     <a class="ml-2" onclick="eventosLanding('Pago en Línea');" href="https://www.pmgchile.com/contacto/"><img width="70" src="https://i.imgur.com/rfpxpiW.png"></a></span>
                </div>
                <br><br>
