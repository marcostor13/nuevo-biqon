    ...
    linear-gradient(
     ...
     <!-- <div id="CMPAbogados" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: contain; max-height:200px">-->
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
             <img style="max-width:200px; max-height:100px" class="img-fluid col-md-3 mt-2" src="{{$landing->logo}}" alt="ZONASUR">
            ...
            <div id="cont2" class="p-5 hide">
                ...
                <p class="text-black">
                    Sabemos que muchos de ustedes, atraviesan momentos de gran incertidumbre y hacen frente a enormes desafios, debido a los drasticos cambios que se estan produciendo como consecuencia de la crisis del COVID-19. ZONA SUR, Por mandato de TANNER, informa que tiene una cuenta pendiente, si requiere informacion le ofrecemos las siguientes opciones:
                </p>
