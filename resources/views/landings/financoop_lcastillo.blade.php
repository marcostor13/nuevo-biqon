            ...
            <div class=col-md-12>
                    ...
                    <div id="cont2" class="p-2 pl-3 pr-3">
                        <div class="card">     
                         ...
                         <strong> debe presentar solo su Carnet de Identidad</strong></h5>
                                  <h5> <strong> 
                              <!--<br>* Nuevo monto de crédito $ 1.800.000<br>-->
                              <br>* enviar vía WHATSAPP  o  comunicarse con su  ejecutivo<br>
                              <!--<br>* Créditos socios nuevos o Compras de cartera hasta $ 1.500.000<br>-->
                              <br>* Comience a cancelar en Septiembre  <strong>Plazo Máximo para solucionar cuota morosa 20 de Julio para solucionar <strong>.<br>
                                   </strong> </h5>
                               </p></h4>
