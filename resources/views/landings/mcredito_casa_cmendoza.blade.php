...
$enddate=strtotime("+4 days", $startdate);
?>
<style>
.opaco{
  ...
  border-color: #A1CBF3 !important;
    ...
    <!-- <div id="mundocredito" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;">-->
        ...
        <div class="content container-fluid d-flex flex-column align-items-center justify-content-start p-0">
         ...
         <a onclick="eventosLanding('Contactar con un Ejecutivo');" href="tel:+56967599344" class="btn bg-primary text-white col-12 mt-4"><img width="40" src="https://puertascolmena.com/wp-content/uploads/2019/05/img2.png">Contactarme con un ejecutivo</a>


               
                    <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56967599344&text=Hola,%20tengo%20una%20consulta" class="btn bg-primary text-white col-12 mt-4"><img width="40" src="https://i.pinimg.com/originals/79/dc/31/79dc31280371b8ffbe56ec656418e122.png">Enviar SMS por Whatsapp</a>
    ...
    <script>
     ...
     $(function(){
        ...
        function sendMail(msg = false){
            ...
            var correo = ["cmendoza@prainabogados.cl"];
            let dataSend = {
