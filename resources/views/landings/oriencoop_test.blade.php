...
<p class="text-white text-center"><br><strong>Seleccione alguna de estas opciones para comunicarse con un Ejecutivo quien podrá asesorarle y resolver sus consultas.</strong><br></p>
                    ...
                    <span class="text-white  text-center">Hazte Socio<br>
                     <a class="ml-2" onclick="eventosLanding('Hazte Socio');" href="https://www.oriencoop.cl/hazte-socio.htm"><img width="50" src="https://img.freepik.com/free-vector/plain-credit-card-concept-illustration_114360-199.jpg?size=338&ext=jpg"></a></span>
                </div>
                <br><br>
