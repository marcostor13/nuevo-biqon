...
.oscurecer {
            ...
            <div id="cont5" class="p-2 pl-3 pr-3 hide">
                        <div class="card">     
                            <div class="card-body">
                                 ...
                                 <a href="tel:+56994390247" class="btn bg-primary text-black col-12 mt-4"> Contactar</a>
                            </div>
                        </div>
                    </div>
              ...
              <div class="date btn bg-primary text-black col-12 mt-4">
               ...
               <!-- <button  class="btn bg-primary text-black col-12 mt-4">Convenio de pago, Contactar
                ...
                <!-- < <div class="btn bg-primary text-black col-12 mt-4">-->
                    ...
                    <a href="tel:+56994390247" class="btn bg-primary text-black col-12 mt-4"> Convenio de pago, Contactar</a> 
                <!-- <</div>-->
 ...
 <br>
                <p class="text-black">
                Para mas Informacion Comunicarse con el Ejecutivo(a) : <strong>NATALIA OYARCE</strong> 
                </p>
                <br>
                 <br>
                <div class="d-flex justify-content-around align-content-center mt-4">
                    <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56994390247&text=Hola,%20tengo%20una%20consulta"><img width="40" src="https://i.pinimg.com/originals/6b/6f/95/6b6f9559658ad9c3d371977a674e2a56.png"></a>
                
                    <a onclick="eventosLanding('Llamar');" href="tel:+56994390247 "><img width="40" src="https://puertascolmena.com/wp-content/uploads/2019/05/img2.png"></a>

                    <a onclick="eventosLanding('Correo');" href="mailto:tamara.perez@proinnova.cl?subject=Landing%20ProInnova"><img width="40" src="https://www.internet-didactica.es/wp-content/uploads/que-es-email-correo-electronico-640x640.jpg"></a>
                </div>
   ...
   //EVENT 1
        ...
        function sendMail(msg = false){
            ...
            var correo = ["tamara.perez@proinnova.cl"];  
            let dataSend = {
