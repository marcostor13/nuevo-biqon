  ...
  background-image: 
    ...
    <div id="Financoop" class="oscurecer" style="background: url('{{$landing->background}}'); background-repeat: no-repeat; background-size: cover;" >
       ...
       <div class="content container-fluid d-flex flex-column align-items-center justify-content-center p-0 w-100">
            ...
            <div id="cont2" class="p-5 hide">
                ...
                <button onclick='window.location.href="tel:+56961682581" 'class="btn bg-warning text-black col-12 mt-4">CONSULTAS</button>
                ...
                <div class="d-flex justify-content-around align-content-center mt-4"> 
                    <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=56961682581&text=Hola,%20tengo%20una%20consulta"><img width="40" src="https://i.pinimg.com/originals/6b/6f/95/6b6f9559658ad9c3d371977a674e2a56.png"></a>
                   
                    <a onclick="eventosLanding('Llamar');" href="tel:+56961682581"><img width="40" src="https://i.imgur.com/Oh5DCRW.png"></a>
                   
                    <a onclick="eventosLanding('Correo');" href="mailto:carmen.sandoval@financoop.cl"><img width="40" src="https://es.seaicons.com/wp-content/uploads/2015/10/Email-icon.png"></a>
                </div>
   ...
   //EVENT 1
        ...
        function sendMail(msg = false){
            ...
            var correo = ["jesus.binteraction@gmail.com","carmen.sandoval@financoop.cl"];
            let dataSend = {
