            ...
            <div id="cont2" class="p-5 hide">
                ...
                <p class="text-black">  
                    ...
                    <br>
                      ...
                      <a onclick="eventosLanding('Llamar');" href="tel:+56967599344" class="btn bg-primary text-white col-12 mt-4">Llamar a Ejecutivo</a> 

                      <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56967599344&text=Hola,%20tengo%20una%20consulta"  class="date btn bg-primary text-white col-12 mt-4">Contactar por WhatsApp</a>  
    ...
    <script>
     ...
     $(function(){
        ...
        let getAllUrlParameter = function() {
         ...
         var rut; 
         rut= getUrlParameter('rut'); 
   window.location.href = "mailto:cmendoza@prainabogados.cl?subject=Pago%20de%20Cuenta%20%20RUT:%20"+rut;
     }  
    </script>
