            ...
            <div id="cont5" class="p-2 pl-3 pr-3 hide">
                        <div class="card">     
                            <div class="card-body">
                                 ...
                                 <a href="tel:+56944703905" class="btn bg-danger text-white col-12 mt-4"> Contactar</a>
                            </div>
                        </div>
                    </div>
             ...
             <!-- <div class="date btn bg-danger text-white col-12 mt-4">
               ...
               <!-- <button  class="btn bg-danger text-white col-12 mt-4">Convenio de pago, Contactar
                ...
                <!-- < <div class="btn bg-danger text-white col-12 mt-4">-->
                    ...
                    <a onclick="eventosLanding('Convenio'); window.location.href='tel:+56944703905' ;" class="btn bg-danger text-white col-12 mt-4"> Convenio de pago, Contactar</a> 
                <!-- <</div>-->
               <!-- <button onclick='window.location.href="https://vtr.com/?pagoexpress=1"; eventosLanding("Pagina de Pagos"); ' class="btn bg-danger text-white col-12 mt-4">PAGAR AHORA</button>-->
                ...
                <br>
<br>
                <center><p class="text-yellow  text-center"> Por favor para mas informacion Contactar a Ejecutivo(a) : <strong>Maria Jose Villegas </strong>
                </p></center>
                
                <div class="d-flex justify-content-around align-content-center mt-4">
                    <a onclick="eventosLanding('Whatsapp');" href="https://api.whatsapp.com/send?phone=+56944703905&text=Hola,%20tengo%20una%20consulta"><img width="40" src="https://i.pinimg.com/originals/6b/6f/95/6b6f9559658ad9c3d371977a674e2a56.png"></a>
                   ...
                   <!-- <a onclick="eventosLanding('Llamar');" href="tel:+56945369456 "><img width="40" src="https://puertascolmena.com/wp-content/uploads/2019/05/img2.png"></a>-->
                    ...
                    <a onclick="eventosLanding('Correo');" href="mailto:mvillegas@cobranza.delloroabogados.cl?subject=Landing%20DellOro&body=Adjuto%20es%20el%20Comprobante%20de%20Pago">
   ...
   //EVENT 1
        ...
        function sendMail(msg = false){
            ...
            var correo = ["mvillegas@cobranza.delloroabogados.cl", "eduardo.binteraction@gmail.com"];  
            let dataSend = {
   ...
   // var id_adm; 
        ...
        function(){
            // window.location.href = "https://api.whatsapp.com/send?phone=+56957657363&text=Hola,%20Adjunto%20Comprobante%20de%20Pago";
             window.location.href="mailto:mvillegas@cobranza.delloroabogados.cl?subject=Landing%20DellOro&body=Adjuto%20es%20el%20Comprobante%20de%20Pago"
        })
