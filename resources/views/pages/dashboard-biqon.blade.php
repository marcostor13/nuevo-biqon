    ...
    <div id="dashboard-content" class="bg-gainsboro">
        ...
        <div class="d-flex justify-content-end mt-5 flex-wrap">
            ...
            <div class="pSelect bg-gainsboro mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="rut" class="mr-3 mt-2 text-black">RUT</label>
                <input type="text" id="rut">
            </div>

            <div class="pSelect bg-gainsboro mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="rutMayorA" class="mr-3 mt-2 text-black">RUT MAYOR A</label>
                <input type="text" id="rutMayorA">
            </div>

            <div class="pSelect bg-gainsboro mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="rutMenorA" class="mr-3 mt-2 text-black">RUT MENOR A</label>
                <input type="text" id="rutMenorA">
            </div>

            <div class="pSelect bg-gainsboro mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="comuna" class="mr-3 mt-2 text-black">COMUNA</label>
                <input type="text" id="comuna">
            </div>

            <div class="pSelect bg-gainsboro mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="direccion" class="mr-3 mt-2 text-black">DIRECCIÓN</label>
                <input type="text" id="direccion">
            </div>

            <div class="pSelect bg-gainsboro mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="telefono" class="mr-3 mt-2 text-black">TELÉFONO</label>
                <input type="text" id="telefono">
            </div>

            <div class="pSelect bg-gainsboro mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="cod_area" class="mr-3 mt-2 text-black">CÓDIGO DE AREA</label>
                <input type="text" id="cod_area">
            </div>
        ...
        <div class=" p-5 flex-wrap">
            <div class="d-flex justify-content-between col-12">
                <div class="pcard rounded p-5 bg-success ml-5">
                ...
                <div class="pcard rounded p-5 bg-danger ml-5">
                ...
                <div class="pcard rounded p-5 bg-warning ml-5">
                    <h3 class="text-right text-black">Total de URL</h3>
                    <div class="d-flex justify-content-between">
                        ...
                        <p  id="totalUrl" class=" text-black mt-2"></p>
                    </div>
                </div>
            ...
            <div class=" col-12 mt-5 p-0">
                ...
                <h1 class="border bg-color2 p-4 text-black mt-4">Visitas</h1>
