    ...
    <div id="dashboard-content" class="bg-gainsboro ">
        ...
        <div class=" p-5 flex-wrap">
            ...
            <div class=" col-12 mt-5 p-0">
                ...
                <table id="tablaLandings" class="text-green p-0" data-toggle="table" data-height="500" data-pagination=true data-search=true  data-toolbar="#toolbar" data-show-export="true" data-locale='ES'>
                    <thead>
                        <tr>
                ...
                <table id="tablaVisitas" class="text-black p-0" data-toggle="table" data-height="500" data-pagination=true data-search=true  data-toolbar="#toolbar" data-show-export="true">
                    <thead>
                        <tr>
                            <th data-field="id">ID</th>
