    ...
    <div id="dashboard-content" class="bg-color1">
        ...
        <div class="d-flex justify-content-end mt-5 flex-wrap">
            ...
            <div class="pSelect mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="byLanding" class="mr-3 mt-2 text-white">LANDING</label>
            ...
            <div class="pSelect mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="byRut" class="mr-3 mt-2 text-white">RUT</label>
            ...
            <div class="pSelect mt-5 d-flex justify-content-center align-items-center mr-5">
                <label for="byPhone" class="mr-3 mt-2 text-white">TELÉFONO</label>
            ...
            <input id="startDate" type="text" class="border text-white mt-5 datepicker mr-5" value="{{ $date }}"/>
            <input id="endDate" type="text" class="border text-white mt-5 datepicker mr-5" value="{{ $date }}"/>            
        </div>
        
        <div class=" p-5 flex-wrap">
            <div class="d-flex justify-content-between col-12">
                <div class="pcard rounded p-5 bg-color1 ml-5">
                    <h3 class="text-right text-white">Total de landings</h3>
                    <div class="d-flex justify-content-between">
                        ...
                        <p id="totalLandings" class=" text-white mt-2"></p>
                    </div>
                </div>
                ...
                <div class="pcard rounded p-5 bg-color1 ml-5">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <p  id="totalVisitas" class=" text-white mt-2"></p>
                    </div>
                </div>
                ...
                <div class="pcard rounded p-5 bg-color1 ml-5">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <p  id="totalFormularios" class=" text-white mt-2"></p>
                    </div>
                </div>
    
                <div class="pcard rounded p-5 bg-color1 ml-5">
                    <h3 class="text-right text-white">Total de Eventos</h3>
                    <div class="d-flex justify-content-between">
                        <img class="mt-3" width="50" height="50" src="https://img.icons8.com/nolan/64/000000/event-accepted.png" alt="">
                        <p  id="totalEventos" class=" text-white mt-2"></p>
                    </div>
                </div>
            ...
            <div class=" col-12 mt-5 p-0">
                ...
                <h1 class="border bg-color1 p-4 text-white">Landings Pages</h1>
                ...
                <h1 class="border bg-color1 p-4 text-white mt-4">Vistas</h1>
                ...
                <table id="tablaVisitas" class="text-white p-0" data-toggle="table" data-height="500" data-pagination=true data-search=true  data-toolbar="#toolbar" data-show-export="true">
                 ...
                 <h1 class="border bg-color1 p-4 text-white mt-4">Formularios</h1>
                ...
                <table id="tablaFormularios" class="text-white p-0" data-toggle="table" data-height="500" data-pagination=true data-search=true  data-toolbar="#toolbar" data-show-export="true">
                 ...
                 <h1 class="border bg-color1 p-4 text-white mt-4">Eventos</h1>
